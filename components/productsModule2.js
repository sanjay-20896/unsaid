...
import UnlockingProductModule from '../components/unlockingProductModule2'
    ...
    return (
        <>
         <div className="productsModule">
            ...
            <Space height="9.6rem"/>
            <UnlockingProductModule img1="/images/product-1a.png" img2="/images/product-1b.png" productName="Product name" productPrice="€1,250" viewProductSection="View all necklaces" productSectionLink="#"/>
            <Space height="9.6rem"/>
            ...
            <Space height="9.6rem"/>
            <SingleProduct img1="/images/product-4a.png" img2="/images/product-4b.jpg" productName="Product name" productPrice="€1,250" viewProductSection="View all necklaces" productSectionLink="#"/>
