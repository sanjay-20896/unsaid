...
function SimpleProductView(props) {
                    ...
                    <div className="productInfoMobile">
                        <div className="nameAndPrice">
                            <div className="pn">
                                <Link href={productUri}>
                                    <a>
                                        <div className="productName anoRegular font16">{props.product.name}</div>
                                    </a>
                                </Link> 
                            </div> 
                            <div className="productPrice font16 anoRegular grey" key={`product_price_mobile_${props?.selection?.selection?.location?.pricelist}`}>{props.product.prices?getPriceBasedOnSelection(props.product,props.selection):formatPrice(props.product.price)}</div>
                        </div>
...
export default connect(mapStateToProps,null)(SimpleProductView)