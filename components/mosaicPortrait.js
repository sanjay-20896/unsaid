...
export default function MosaicPotrait(props){
            ...
            <div className="wrapper">
                ...
                <div className="imageWrapper">
                    <LazyImage 
                        ...
                        originalSrc={getImageUrl(props.article.portraitImage,562)} 
                        placeholderSrc={getImageUrl(props.article.portraitImage,20)}
                        width={562} 
                        height={562} 
                    />
                </div></a>
