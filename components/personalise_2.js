...
function engraving(props) {
    ...
    let selectedPostCardImage1 = index3==0?defaultPostCardImage:postCardProductsWithoutBlank[index3-1]?.media?.standard[0]
    let selectedPostCardImage2 = index3==0?defaultPostCardImage:postCardProductsWithoutBlank[index3-1]?.media?.standard[1]
